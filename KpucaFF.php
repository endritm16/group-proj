...
<body>
  ...
  <main>
    <section class="product-list">
      <div class="product">
        <img src="https://www.futbolemotion.com/imagesarticulos/218093/750/bota-nike-air-zoom-mercurial-superfly-9-academy-turf-nino-pink-foam-black-0.webp" alt="Product 1" width="100px" height="100px">
        <h2>Produkti 1</h2>
        <p>$29.99</p>
...
<br><br>
      <div class="product">
        <img src="https://images.stockx.com/360/Nike-Zoom-Mercurial-Superfly-9-Academy-MG-Luminous-Pack/Images/Nike-Zoom-Mercurial-Superfly-9-Academy-MG-Luminous-Pack/Lv2/img01.jpg" alt="Product 3" width="100px" height="100px">
        <h2>Produkti 9</h2>
        <p>$19.99</p>
        <button>Add to Cart</button>
      </div>
      <br><br>
      <div class="product">
        <img src="https://images.stockx.com/images/Nike-Mercurial-Superfly-9-Elite-AS-FG-High-Rising-Gem-Pack.jpg?fit=fill&bg=FFFFFF&w=480&h=320&q=60&dpr=1&trim=color&updated_at=1715660809" alt="Product 1" width="100px" height="100px">
        <h2>Produkti 10</h2>
        <p>$29.99</p>
        <button>Add to Cart</button>
      </div>
<br><br>
      <div class="product">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHvmHLRxhR7B90N8YcqS1XQHqee_BcL5se8g&s" alt="Product 2" width="100px" height="100px">
        <h2>Produkti 11</h2>
        <p>$49.99</p>
        <button>Add to Cart</button>
      </div>
<br><br>
      <div class="product">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOZD-nS0Qa2dtBV-NKuHjNt08WGCD2yx4LJg&s" alt="Product 3">
        <h2>Produkti 12</h2>
        <p>$19.99</p>
        <button>Add to Cart</button>
      </div>
