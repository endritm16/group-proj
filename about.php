...
<body>
    ...
    <section id="about" class="about">
      <div class="container">
          ...
          <p>Për më shumë se 50 vjet, Nike ka frymëzuar atletët në mbarë botën me produkte inovative të krijuara për t'i ndihmuar ata të arrijnë madhështinë. Nga këpucët tek veshjet, misioni ynë është të ofrojmë produkte të cilësisë më të lartë për të gjithë atletët.</p>
      </div>
  </section>
  <!-- Contact Section -->
  <section id="contact" class="contact">
      <div class="container">
          ...
          <a href="mailto:support@nike.com" class="btn">Email Us</a>
      </div>
  </section>
